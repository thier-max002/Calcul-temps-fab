...
# --- 1. BASE DE DONNÉES COMPLÈTE (AVEC SOUS-GAMMES PAAL) ---
DATABASE = {
    "SCHÜCO": {
        "Fenêtre AWS 60 /BD": {
            "types": {"Oscillo-battant 1 vantail": 2.0, 
                      "Oscillo-battant 2 vantaux": 3.0, 
                      "Fixe": 0.75, 
                      "Française 1 vantail": 1.5, 
                      "Française 2 vantaux": 2.5},
            "options": {"Couvre joint à cliper": 0.16, 
        ...
        "Porte ADS 60": {
            ...
            "options": {"Couvre joint à cliper": 0.16, 
                        ...
                        "Ferme porte": 0.33, 
                        "Grilles Air Frais": 0.33, 
                        "Mise en place profil en T": 0.25,
                        "Bâton maréchal": 0.5, 
        ...
        "Porte fenêtre": {
            ...
            "options": {"Couvre joint à cliper": 0.16, 
                        ...
                        "Mise en place profil en T pour composé": 0.25, 
                        "Bandeau serrure dans ouvrant caché": 2.0, 
                        "Ferme porte": 0.33, "Bâton maréchal": 0.5, 
                        "Verrouillage semi fixe": 0.5, 
                        "Seuil PMR ou seuil plat frappe": 0.5, 
                        "Serrure 3 points": 0.5, 
                        "Bandeau ventouse 1 vantail ": 0.33, 
                        "Bandeau ventouse 2 vantaux": 0.75, 
                        "Fixation composé": 0.5}
        },
        "ASS 39 SC": {
            "types": {"Coulissant 2 vantaux": 2.0, 
    ...
    "PAAL": {
        "PAAL 52": {
            "Fenêtre": {
                ...
                "options": {"Couvre joint à cliper": 0.16, 
                            ...
                            "Vitrage ouvrant caché": 0.16, 
                            "Bandeau serrure dans ouvrant caché": 2.0,
                            "1 Traverse": 0.15, "2 Traverses": 0.3, 
                            "3 Traverses": 0.45, "1 Montant": 0.15, 
                            "2 Montants": 0.3, "3 Montants": 0.45}
            },
            "Porte": {
                "types": {"Porte 1 vantail": 4.0, 
                          "Porte 2 vantaux": 6.0, 
            ...
            "Persienne": {
                "types": {"Persiennes nue (temps par VTL)": 1.0, 
        ...
        "PAAL 70": {
            ...
            "Coulissant": {
                "types": {"Coulissant 2 vantaux": 2.25, 
                          "Coulissant 3 vantaux": 2.75, 
                          "Coulissant 4 vantaux": 3.25, 
                          "Galandage 1 vantail": 3.5, 
                          "Galandage 2 vantaux sur 1 côté": 4.0, 
